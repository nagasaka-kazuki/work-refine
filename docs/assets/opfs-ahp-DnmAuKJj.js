...
var B = 'state.txt',
  ...
  U = class extends H {
    constructor(
      t,
      {
        initialPoolSize: e = 1e3,
        maintainedPoolSize: a = 100,
        debug: i = !1,
      } = {}
    ) {
      super(t, { debug: i }),
    ...
    async init(t, e) {
      return await o(this, l, R).call(this), super.init(t, e)
    }
    async syncToFs(t = !1) {
    ...
    async maybeCheckpointState() {
      Date.now() - this.lastCheckpoint > this.checkpointInterval &&
    ...
    _mkdirState(t, e) {
      ...
      for (let d of a) {
        if ((h.push(t), !Object.prototype.hasOwnProperty.call(r.children, d)))
          if (e?.recursive) this.mkdir(h.join('/'))
          else throw new p('ENOENT', 'No such file or directory')
        if (r.children[d].type !== 'directory')
          throw new p('ENOTDIR', 'Not a directory')
        r = r.children[d]
      }
      if (Object.prototype.hasOwnProperty.call(r.children, i))
    ...
    open(t, e, a) {
      if (o(this, l, f).call(this, t).type !== 'file')
    ...
    _renameState(t, e, a = !1) {
      ...
      if (a && Object.prototype.hasOwnProperty.call(n.children, d)) {
        let u = n.children[d]
        s(this, y).get(u.backingFilename).truncate(0),
          this.state.pool.push(u.backingFilename)
      }
    ...
    _rmdirState(t) {
      ...
      if (Object.keys(h.children).length > 0)
    ...
    _unlinkState(t, e = !1) {
      ...
      if ((delete h.children[i], e)) {
        ...
        c?.truncate(0),
          s(this, S).add(c),
          s(this, O).has(t) &&
            (s(this, F).delete(s(this, O).get(t)), s(this, O).delete(t))
      }
    ...
    writeFile(t, e, a) {
      ...
      if (Object.prototype.hasOwnProperty.call(r.children, h)) {
        ...
        ;(r.children[h] = n),
          o(this, l, M).call(this, { opp: 'createFileNode', args: [t, n] })
      }
      let c = r.children[h],
  ...
  (R = async function () {
    P(this, T, await navigator.storage.getDirectory()),
      ...
      P(
        this,
        N,
        await o(this, l, x).call(this, L, { from: s(this, I), create: !0 })
      ),
...
`),
    ...
    try {
      ...
      ;(e = {
        ...
        s(this, w).truncate(0),
        s(this, w).write(new TextEncoder().encode(JSON.stringify(e)), {
          at: 0,
        }),
        (i = !0)
    }
      ...
      c = async (n) => {
        if (n.type === 'file')
          try {
            ...
            s(this, k).set(n.backingFilename, u),
              s(this, y).set(n.backingFilename, b)
          } catch (u) {
    ...
    for (let n of this.state.pool)
      d.push(
        new Promise(async (u) => {
          s(this, k).has(n) &&
            console.warn('File handle already exists for pool file', n)
    ...
    await Promise.all([...r, ...d]),
      await this.maintainPool(
        i ? this.initialPoolSize : this.maintainedPoolSize
      )
  }),
  (E = function (t, e) {
...
${e}`),
  ...
  (v = function () {
    let t = ++$(this, j)._
    for (; s(this, F).has(t); ) $(this, j)._++
    return t
  }),
  (x = async function (t, e) {
    let a = o(this, l, g).call(this, t),
      i = e?.from || s(this, T)
    for (let h of a) i = await i.getDirectoryHandle(h, { create: e?.create })
    return i
  })
